...
const jobs = [
  {
    ...
    type: "Full-Time",
    salary: "45,000 BDT",
    description: "Develop and maintain responsive web applications using modern JavaScript frameworks.",
    status: "All"
  },
  {
    id: 2,
    ...
    type: "Full-Time",
    salary: "55,000 BDT",
    description: "Build secure APIs and manage databases using Node.js and Express.",
    status: "All"
  },
  {
    id: 3,
  ...
  },
  {
    ...
    type: "Full-Time",
    salary: "50,000 BDT",
    description: "Design user-friendly interfaces and improve user experience across platforms.",
    status: "All"
  },
  {
    id: 5,
    ...
    type: "Full-Time",
    salary: "35,000 BDT",
    description: "Manage online campaigns, social media ads, and performance tracking.",
    status: "All"
  },
  {
    id: 6,
    ...
    type: "Full-Time",
    salary: "30,000 BDT",
    description: "Provide technical assistance and resolve customer issues efficiently.",
    status: "All"
  },
  {
    id: 7,
  ...
  },
  {
    ...
    type: "Full-Time",
    salary: "42,000 BDT",
    description: "Maintain network infrastructure and ensure system security and performance.",
    status: "All"
  }
];
...
mainContainer.addEventListener('click', function(event) {
    if(event.target.classList.contains('interviewBtn')){
      ...
      const jobExist = interviewJobs.find(item => item.companyName == cardInfo.companyName)
      if (!jobExist) {
            interviewJobs.push(cardInfo)
        }

        rejectedJobs = rejectedJobs.filter(item => item.companyName != cardInfo.companyName)

        if (currentStatus == 'filter-rejected-btn') {
            // renderStruggling()                                      //ekhono kora hoinai
        }
        calculateCount()
      ...
      const jobExist = rejectedJobs.find(item => item.companyName == cardInfo.companyName)
      if (!jobExist) {
            rejectedJobs.push(cardInfo)
        }

        interviewJobs = interviewJobs.filter(item => item.companyName != cardInfo.companyName)
...
function renderInterview(){
  ...
  for(interview of interviewCards ){
    ...
    `
    div.appendChild(interviewCards)
  }
}
